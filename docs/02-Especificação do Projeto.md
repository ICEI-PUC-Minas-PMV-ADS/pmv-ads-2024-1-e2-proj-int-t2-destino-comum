...
|RF-003| A aplicação permitirá: usuário e realizar login | ALTA |
...
|RF-005| A aplicação deve permitir aos usúarios que possam pesquisar as cidades de seu interesse | ALTA |
|RF-006| A aplicação deve permitir que os demais usuários possam votar em suas perguntas ou dicas favoritas | MÉDIA | 
|RF-007| A aplicação deve automaticamente avaliar os melhores comentário e os evidenciar em "destaque" | MÉDIA |
|RF-008| A aplicação deve permitir aos usúarios que possam definir seus destinos favoritos | MÉDIA |
|RF-009| A aplicação deve permitir aos usúarios reportar comentários impróprios | MÉDIA |
|RF-010| A aplicação deve permitir que os usuários recebam notificações | MÉDIA |
|RF-011| A aplicação deve permitir que o administrador bloqueie ou exclua usuários | ALTA |
|RF-012| A aplicação deve permitir que o administrador exclua comentários reportados como impróprios pelos usuários | ALTA |
...
|RNF-009| As informações cadastrais do usuário (nome completo, CPF, etc) devem estar disponíveis apenas para o próprio usuário | ALTA |
